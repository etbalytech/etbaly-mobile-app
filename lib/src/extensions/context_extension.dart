...
extension ContextExtension on BuildContext {
  ...
  /// Etbaly brand colors (purple, gold, backgrounds, etc.)
  EtbalyColorsExtension get etbalyColors =>
      theme.extension<EtbalyColorsExtension>() ??
      (isDarkMode ? EtbalyDarkPalette.colors : EtbalyLightPalette.colors);
  ...
  void showSuccessSnackBar(String message) {
    ScaffoldMessenger.of(this)
      ...
      ..showSnackBar(
        SnackBar(
          content: Text(message),
          backgroundColor: etbalyColors.success,
        ),
      );
  }
